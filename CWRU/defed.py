...
if __name__ == '__main__':
    ...
    file_name = '../save/node{}/model/defed_global_model_{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}]_M[{}]_p[{}].pt'.\
        format(args.num_users, args.dataset, args.model, args.epochs, args.frac, args.iid, args.local_ep, args.local_bs, args.method, args.p)
    os.makedirs(os.path.dirname(file_name), exist_ok=True)
    torch.save(global_model.state_dict(), file_name)
    for ind in range(len(idxs_users)):
        file_name = '../save/node{}/model/defed_model{}_{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}]_M[{}]_p[{}].pt'.\
            format(args.num_users, ind, args.dataset, args.model, args.epochs, args.frac, args.iid, args.local_ep, args.local_bs, args.method, args.p)
        os.makedirs(os.path.dirname(file_name), exist_ok=True)
    ...
    plt.legend()
    file_name = '../save/node{}/figure/New_fed_w_only_{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}]_M[{}]_p[{}]_loss.png'.\
        format(args.num_users, args.dataset, args.model, args.epochs, args.frac, args.iid, args.local_ep, args.local_bs, args.method, args.p)
    os.makedirs(os.path.dirname(file_name), exist_ok=True)
    ...
    plt.xlabel('Communication Rounds')
    plt.legend()
    file_name = '../save/node{}/figure/New_fed_w_only_{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}]_M[{}]_p[{}]_acc.png'.\
        format(args.num_users, args.dataset, args.model, args.epochs, args.frac, args.iid, args.local_ep, args.local_bs, args.method, args.p)
    os.makedirs(os.path.dirname(file_name), exist_ok=True)
    plt.savefig(file_name)
    ...
    plt.ylabel('Training loss')
    plt.xlabel('Communication Rounds')
    file_name = '../save/node{}/figure/New_Avg_fed_w_only_{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}]_M[{}]_p[{}]_loss.png'.\
        format(args.num_users, args.dataset, args.model, args.epochs, args.frac, args.iid, args.local_ep, args.local_bs, args.method, args.p)
    os.makedirs(os.path.dirname(file_name), exist_ok=True)
    plt.savefig(file_name)
    ...
    plt.ylabel('Average Accuracy')
    plt.xlabel('Communication Rounds')
    file_name = '../save/node{}/figure/New_Avg_fed_w_only_{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}]_M[{}]_p[{}]_acc.png'.\
        format(args.num_users, args.dataset, args.model, args.epochs, args.frac, args.iid, args.local_ep, args.local_bs, args.method, args.p)
    os.makedirs(os.path.dirname(file_name), exist_ok=True)
    plt.savefig(file_name)
