...
# def get_score_defed(state_dict, bmean, ymean):
#     weight = state_dict['layer_input.weight'].cpu().numpy()
#     output = (np.sum(weight) + bmean - ymean)**2
#     print(f'weight:{weight} | bias_mean:{bmean} | output:{output}')
#     return output
